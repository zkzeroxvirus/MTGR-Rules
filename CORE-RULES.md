...
• The Host draws a random encounter  
 • Both sides roll a d20  
...
Town provides recovery and controlled progression.
...
After Town:  
• Resolve 1 Event before the next encounter

---

## **🏪 TOWN BUILDINGS**

Town uses a limited-use building system.
...
• The Host becomes stronger  
 • Future encounters increase in difficulty
...
### **⚠️ Optional Rule (Host Discretion)**

Hosts may apply a penalty on death, such as:

 • A Curse  
 • A temporary debuff  
 • A custom negative effect

This is optional and not part of the base ruleset.
...
## **💀 THE CRYPT**
 ...
 • Significantly harder than prior fights
...
Standard mode:
 ...
 • 3 encounters, then Crypt  
 • Tier 4 Affixes are not used

Variant mode:

 • 4 encounters, then Crypt  
...
• Pre-Con Draft Option: Disabled

Applies to all tables unless otherwise stated.
